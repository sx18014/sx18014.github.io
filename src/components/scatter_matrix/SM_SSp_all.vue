...
export default {
  ...
  methods: {
    ...
    async updateChart () {
      ...
      var data = await axios.get('https://sx18014.github.io/dist/data/SSP-all.json')
      ...
      var option = {
        ...
        visualMap: {
          type: 'piecewise',
          categories: ["SSp-bfd","SSp-ll","SSp-m","SSp-n","SSp-ul"],
          dimension: CATEGORY_DIM,
          orient: 'horizontal',
          top: 0,
          left: 'center',
          inRange: {
            color: ['#893448', '#d95850', '#eb8146', '#ffb248', '#f2d643']
          },
          outOfRange: {
